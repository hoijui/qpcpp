...
//            Video::printNumAt(1, 24, Video::FGND_YELLOW, key);
        ...
        case 46: {                                                      // 'c'
            static QEvent const ce = { C_SIG, 0 };
            AO_UI->postFIFO(&ce);
            break;
        }
        case 18: {                                                      // 'e'
            static QEvent const cee = { CE_SIG, 0 };
            AO_UI->postFIFO(&cee);
            break;
        }
        case 28: {                                                    // ENTER
            static QEvent const ee = { ENTER_SIG, 0 };
            AO_UI->postFIFO(&ee);
            break;
        }
        case 200: {                                                // UP-arrow
            static QEvent const ue = { UP_SIG, 0 };
            AO_UI->postFIFO(&ue);
            break;
        }
        case 208: {                                              // DOWN-arrow
            static QEvent const de = { DOWN_SIG, 0 };
            AO_UI->postFIFO(&de);
            break;
        }
        case 59: {                                                       // F1
            static QEvent const he = { HELP_SIG, 0 };
            AO_UI->postFIFO(&he);
            break;
        }
        case 129: {                                                     // ESC
            static QEvent const qe = { QUIT_SIG, 0 };
            QF::publish(&qe);
            break;
        }
    }
